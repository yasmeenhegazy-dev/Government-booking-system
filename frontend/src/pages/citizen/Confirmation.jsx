...
import { getAppointmentByReference } from "../../lib/api.js";

export default function CitizenConfirmation() {
  const [searchParams] = useSearchParams();
  const { appointments, loading } = useCitizenSession();
  ...
  if (loading || resolving) {
    return <LoadingSpinner message="جاري تحميل بيانات التأكيد..." />;
  }
    ...
    return (
      <div className="max-w-2xl mx-auto card-standard text-center py-12">
        ...
        <div className="flex gap-3 justify-center mt-5">
          <Link to="/citizen/appointments" className="btn-secondary">
            عرض الحجوزات
          </Link>
