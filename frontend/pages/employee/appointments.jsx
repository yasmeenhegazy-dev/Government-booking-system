...
export default function EmployeeAppointments() {
  ...
  const fetchData = async () => {
    ...
    try {
      setLoading(true);
      setError(null);
      const result = await getTodayAppointments(session.branch._id, date);
      setData(result);
    } catch (err) {
  ...
  const handleExportCsv = () => {
    ...
    const headers = ["المواطن", "الرقم القومي", "الخدمة", "التوقيت", "الحالة", "رقم الحجز"];
